...
void protobuf_AddDesc_ortools_2fsat_2fsat_5fparameters_2eproto();
void protobuf_AssignDesc_ortools_2fsat_2fsat_5fparameters_2eproto();
void protobuf_ShutdownFile_ortools_2fsat_2fsat_5fparameters_2eproto();
...
class SatParameters : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:operations_research.sat.SatParameters) */ {
 public:
  ...
  // optional bool use_disjunctive_constraint_in_cumulative_constraint = 80 [default = false];
 ...
 private:
  ...
  inline void set_has_use_overload_checker_in_cumulative_constraint();
  inline void clear_has_use_overload_checker_in_cumulative_constraint();
  ...
  inline void set_has_use_disjunctive_constraint_in_cumulative_constraint();
  inline void clear_has_use_disjunctive_constraint_in_cumulative_constraint();
  inline void set_has_use_global_lp_constraint();
  inline void clear_has_use_global_lp_constraint();
  inline void set_has_use_fixed_search();
  inline void clear_has_use_fixed_search();
  inline void set_has_optimize_with_core();
  inline void clear_has_optimize_with_core();
  ...
  friend void  protobuf_AddDesc_ortools_2fsat_2fsat_5fparameters_2eproto();
  friend void protobuf_AssignDesc_ortools_2fsat_2fsat_5fparameters_2eproto();
  friend void protobuf_ShutdownFile_ortools_2fsat_2fsat_5fparameters_2eproto();
...
inline void SatParameters::clear_use_disjunctive_constraint_in_cumulative_constraint() {
  use_disjunctive_constraint_in_cumulative_constraint_ = false;
