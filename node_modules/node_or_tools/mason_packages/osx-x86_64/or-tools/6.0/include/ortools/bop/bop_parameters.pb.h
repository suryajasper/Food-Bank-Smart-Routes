...
void protobuf_AddDesc_ortools_2fbop_2fbop_5fparameters_2eproto();
void protobuf_AssignDesc_ortools_2fbop_2fbop_5fparameters_2eproto();
void protobuf_ShutdownFile_ortools_2fbop_2fbop_5fparameters_2eproto();
...
class BopOptimizerMethod : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:operations_research.bop.BopOptimizerMethod) */ {
 ...
 private:
  ...
  int type_;
  friend void  protobuf_AddDesc_ortools_2fbop_2fbop_5fparameters_2eproto();
  friend void protobuf_AssignDesc_ortools_2fbop_2fbop_5fparameters_2eproto();
  friend void protobuf_ShutdownFile_ortools_2fbop_2fbop_5fparameters_2eproto();
