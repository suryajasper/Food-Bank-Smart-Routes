...
void protobuf_AddDesc_ortools_2fglop_2fparameters_2eproto();
void protobuf_AssignDesc_ortools_2fglop_2fparameters_2eproto();
void protobuf_ShutdownFile_ortools_2fglop_2fparameters_2eproto();
...
class GlopParameters : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:operations_research.glop.GlopParameters) */ {
 public:
  ...
  inline GlopParameters* New() const { return New(NULL); }

  GlopParameters* New(::google::protobuf::Arena* arena) const;
 ...
 private:
  ...
  inline void set_has_drop_tolerance();
  inline void clear_has_drop_tolerance();
  ...
  inline void set_has_max_number_of_reoptimizations();
  inline void clear_has_max_number_of_reoptimizations();
  ...
  inline void set_has_use_solowhalim();
  inline void clear_has_use_solowhalim();
  inline void set_has_perturb_costs_in_dual_simplex();
  inline void clear_has_perturb_costs_in_dual_simplex();
  inline void set_has_relative_cost_perturbation();
  inline void clear_has_relative_cost_perturbation();
  inline void set_has_relative_max_cost_perturbation();
  inline void clear_has_relative_max_cost_perturbation();
  ...
  friend void  protobuf_AddDesc_ortools_2fglop_2fparameters_2eproto();
  friend void protobuf_AssignDesc_ortools_2fglop_2fparameters_2eproto();
  friend void protobuf_ShutdownFile_ortools_2fglop_2fparameters_2eproto();
